    ...
    <div className="card-body">
      ...
      <div className="stats shadow my-4">
        <div className="stat place-items-center">
          ...
          <div className="stat-value text-primary">{user?.data?.currentStreak || 0}</div>
        ...
        <div className="stat place-items-center">
          ...
          <div className="stat-value text-secondary">{user?.data?.longestStreak || 0}</div>
          <div className="stat-desc">your best record</div>
        </div>
      </div>
